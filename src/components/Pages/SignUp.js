...
import { X, RefreshCcw } from "lucide-react"; // Retry arrow icon
...
export default function SignUp() {
  ...
  const onSubmit = async () => {
    ...
    setShowOTP(true);
    setTimeLeft(120); // Reset the timer to 2 minutes on sign-up
  };
              ...
              >
                <div className="bg-gray-800 p-8 rounded-lg shadow-2xl relative max-w-lg">
                  ...
                  <p className="text-sm text-gray-400 mb-4">
                    We've sent a one-time password to {signupData.email}. Please
                  ...
                  {signupError && (
                    <p className="text-red-500 text-xs mb-4">{signupError}</p>
                  )}
                  ...
                  <button
                    disabled={signupIsLoading || timeLeft === 0}
