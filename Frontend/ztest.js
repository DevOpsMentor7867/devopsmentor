    ...
    >
      {tools.map((tool, index) => (
        <motion.div key={tool.name} variants={itemVariants}>
          <Card
            className={`bg-[#1A202C]/50 border-2 transition-colors group p-6
            ${
              index % 3 === 0
                ? "border-[#09D1C7]/20 hover:bg-[#09D1C7]/5"
                : index % 3 === 1
                ? "border-[#80EE98]/20 hover:bg-[#80EE98]/5"
...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen overflow-y-auto">
      ...
      {/* Footer */}
      <footer className="bg-[#1A202C] text-white/80 py-12 ">
